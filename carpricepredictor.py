...
data2 = pd.read_csv('datasets/carvana_car_sold-2022-08.csv')
data3 = pd.read_csv('datasets/car_web_scraped_dataset.csv')
...
best_model = RandomForestRegressor(max_depth=None, min_samples_split=5, n_estimators=200,
                                   random_state=42)
